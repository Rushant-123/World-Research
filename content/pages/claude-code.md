...
An interactive CLI application that allows developers to use Claude AI for coding tasks directly from their terminal. It can read files, write code, execute commands, search codebases, and assist with software development workflows. The tool combines local execution with cloud-based AI processing.

## Steps to Make:

1. Obtain a [Mac Computer](mac) to run the CLI application
